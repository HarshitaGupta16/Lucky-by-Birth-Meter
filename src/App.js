...
import formBackground from "/src/images/form-background.svg";
import "./styles.css";
...
export default function App() {
  ...
  const clickHandler = (event) => {
    ...
    return (
      <LuckyNumber bDate={birthday} luckyNo={luckyNumber} className="output" />
    );
  };
      ...
      <section id="form-page" className="section">
        ...
        <footer>
          ...
          <ul className="list-non-bullet">
            ...
            <li className="list-item-inline">
              <a href="https://twitter.com/Harshita16Gupta" target="_blank">
            ...
            <li className="list-item-inline">
              <a
                href="https://www.instagram.com/__harshita__gupta__/"
                target="_blank"
              >
            ...
            <li className="list-item-inline">
              <a href="https://harshitagupta.netlify.app" target="_blank">
                <i className="fas fa-briefcase" aria-hidden="true">Portfolio</i>
              </a>
            </li>
          </ul>
        </footer>
